...
namespace control
{
    ...
    public:
        ...
        ControllerManager(core::Logger &logger, core::JsonFileHandler &json_file_handler, std::array<std::shared_ptr<ControllerType>, NumControllers> controllers) : Configurable(logger, json_file_handler, "ControllerManager"),
